...
data_infor_path='D:\A_userfile\lly\data\lovada\code\uvaid_code\data_information\';
...
Prior_matrix=roundn(Prior_matrix,-3).*repmat(class_weight,[7 1]);%保留3位小数
...
for k=3721:training_set_number
    %1.1 根据类别权重抽取当前类别集合
    seedrand=rand();
