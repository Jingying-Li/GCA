...
if curfill_areanum~=0
    ...
    if choose_class==curfill_class
        ...
        if curfill_areanum==1
            ...
            [selected_area_r, selected_indices_r] = selectbasicareaWithIndices(recurclassbasic_allarea, curclass_area-selected_value_part, curfill_areanum-1); %抽取：根据抽取数确定抽取basic unit的信息
